...
num = int(input("Ingrese '1' si quiere su nombre en MAYUSCULAS\nIngrese '2' si quiere su nombre en minusculas\nIngrese '3' si quiere su nombre con la primera letra Mayuscula.\n"))
if num == 1:
    print(nombre.upper())
elif num == 2:
    print(nombre.lower())
...
hemisferio = str(input("En cual hemisferio se encuentra? (N/S): ")).upper()
mes = str(input("Que mes del año es?: ")).lower()
...
if hemisferio == "N":
    if mes == "diciembre" and dia >= 21 and dia <= 31:
        ...
        print("Usted se encuentra en Invierno")
    elif mes == "marzo" and dia >= 1 and dia <= 20:
        print("Usted se encuentra en Invierno")

#Primavera hemisferio norte
if hemisferio == "N":
...
if hemisferio == "N":
    ...
    elif (mes == "julio" or mes == "agosto") and dia >= 1 and dia <= 31:
        print("Usted se encuentra en Verano")
    elif mes == "septiembre" and dia >= 1 and dia <= 20:
        print("Usted se encuentra en Verano")
